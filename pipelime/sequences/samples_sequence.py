...
from pipelime.utils.pydantic_compat import PipelimeModel, iter_fields, model_title
...
class SamplesSequence(SamplesSequenceBase, PipelimeModel, extra="forbid"):
    ...
    @t.overload
    def __getitem__(self, idx: int) -> Sample: ...  # noqa: E704

    @t.overload
    def __getitem__(self, idx: slice) -> SamplesSequence: ...  # noqa: E704
