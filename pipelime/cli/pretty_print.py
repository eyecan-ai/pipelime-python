...
def print_command_inputs(command: "PipelimeCommand"):  # type: ignore # noqa: E602 # noqa: F821
    print_model_field_values(command.__fields__, command.get_inputs(), _input_icon())


def print_command_outputs(command: "PipelimeCommand"):  # type: ignore # noqa: E602 # noqa: F821
