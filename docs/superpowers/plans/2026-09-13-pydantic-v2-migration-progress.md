...
| S0 | S0-T5 (contracts: root wrappers) | todo | | | | |
| S0 | S0-T6 (contracts: Optional semantics & polymorphic dumps) | todo | | | | |
| S0 | S0-T7 (contracts: command framework) | todo | | | | |
| S0 | S0-T8 (contracts: stages/entities/sequences) | todo | | | | |
| S0 | S0-T9 (contracts: validation interfaces, errors, help snapshot) | todo | | | | |
| S0 | S0-T10 (contracts: modern type hints) | todo | | | | |
